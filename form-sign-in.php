...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-wrap" id="home-section">
      ...
      <header class="site-navbar site-navbar-target bg-secondary shadow" role="banner">
		...
		<div class="card">
			<form action="proses-sign-in.php" method="POST" >
				<center>
					<img src="images/desa.webp" width="35%"><br><font"><b>Sign In</b></font></center>
				<br>
			<table align="center">
				<tr>
					<td>Alamat Email</td>
		    	...
		    	<tr>
			  		...
			  		<td>:</td>
			  		<td><input name="nilaiCaptcha" value=" " maxlength="5"/></td>
				<tr>
			</table>
			<br>
			<center>
			...
			<br>
			<font> Sudah Punya Akun ? </font><a href="form-sign-in.php">Sign Up</a>
		</form>
	</div>
